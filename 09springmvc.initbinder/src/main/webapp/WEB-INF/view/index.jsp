...
<body>
	...
	<p>Genero: Tu edad es <strong style="color:red">${userRegister.age}</strong></p>
	
			
	<p>Genero: Tu email es <strong style="color:red">${userRegister.userContact.email}</strong></p>
	
			
	<p>Genero: Tu telefono  es <strong style="color:red">${userRegister.userContact.telefono.userNumber}</strong></p>
	
	<p>Genero: Tu prefijo es <strong style="color:red">${userRegister.userContact.telefono.prefijo}</strong></p>
